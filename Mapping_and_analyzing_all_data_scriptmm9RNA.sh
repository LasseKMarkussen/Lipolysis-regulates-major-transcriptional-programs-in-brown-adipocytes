...
echo $FASTQFILE
star --runMode alignReads --genomeDir /data/Genomes/mouse/mm9/star/index101bp/ --readFilesIn $FASTQFILE --runThreadN 16 --genomeLoad LoadAndKeep --readFilesCommand zcat
...
STAR --genomeLoad Remove --genomeDir /data/Genomes/mouse/mm9/star/index101bp/
rm Log.out
rm Log.progress.out
...
echo $MAPFILE
makeTagDirectory ${MAPFILE/.sam/.TD/} $MAPFILE -format sam -genome mm9 -fragLength given
